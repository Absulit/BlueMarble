...
:: Android packaging
set AND_CERT_NAME="BlueMarbleDemo1"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BlueMarbleDemo1.p12
...
set IOS_PROVISION=cert\BlueMarbleDemo1.mobileprovision
...
set APP_ID=air.BlueMarbleDemo1

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BlueMarbleDemo1
